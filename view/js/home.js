	...
	home: {
		...
		countdown: {
			...
			update: function() {
				...
				if(now > pages.home.countdown.openingDate)
				{
					$("#countdown-timer #count-days").html(0);
					$("#countdown-timer #count-hours").html(0);
					$("#countdown-timer #count-minutes").html(0);
					$("#countdown-timer #count-seconds").html(0);
				}
				else
				{
